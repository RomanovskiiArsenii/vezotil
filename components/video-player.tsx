      ...
      <AnimatePresence>
        {isPlaying && (
          ...
          >
            ...
            <div className="relative w-full max-w-7xl space-y-4">
                    ...
                    {showInfoCard && (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-green-400 text-[10px] font-mono">INFORMATION</span>
                        </div>
                        <h3 className="text-white font-semibold text-xs mb-0.5 leading-tight">{title}</h3>
