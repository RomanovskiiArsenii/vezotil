...
export default function ManufacturerSection() {
  ...
  const achievements = [
    ...
    { icon: Building2, title: 'Разработка и производство в России', description: 'Гарантированное качество и техническая поддержка' }
  ];
      ...
      <div className="container mx-auto px-4 lg:px-8 xl:px-12">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            <span className="hud-text">ООО "ВЕТСТЕМ"</span> - ведущий российский производитель ветеринарных препаратов
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-16">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">121205, г. Москва, тер. Сколково инновационного центра,</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 font-mono text-xs">№ 77-3-29.23-5075ПВР-3-29.23/03889</p>
          ...
          <motion.div
            ...
            className="flex flex-col justify-between h-full min-h-[750px]"
          >
                ...
                >
                  <div className={`w-full lg:w-5/12 ${
                    ...
                    <div className="bg-slate-800/50 p-4 rounded-lg border border-blue-400/30">
                      <div className="hud-text font-bold text-xl mb-2">{item?.year}</div>
