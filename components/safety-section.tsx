              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className={`px-2 py-1 rounded text-xs ${
                    effect?.severity === 'high' ? 'bg-red-900/50 text-red-300' :
                    effect?.severity === 'medium' ? 'bg-amber-900/50 text-amber-300' :
                    'bg-green-900/50 text-green-300'
                  }`}>
                    {effect?.severity === 'high' ? 'Высокая' :
                     effect?.severity === 'medium' ? 'Средняя' : 'Низкая'}
                  </span>
                </div>
              </motion.div>
            ))}
