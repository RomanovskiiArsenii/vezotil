...
export default function FAQDetailedSection() {
    ...
    const faqs: FAQ[] = [
        ...
        },
        {
            ...
            answer: 'Наступление анестезии происходит через 3-5 минут после внутривенного введения и через 5-10 минут после внутримышечного. Продолжительность анестезии составляет 30-60 минут в зависимости от дозы. Пробуждение происходит плавно в течение 2-4 часов. Полное восстановление координации - через 6-8 часов.',
            category: 'general',
            order: 8,
        },
        {
    ...
    const categories = [
        ...
        { id: 'general', name: 'Общие', icon: FileText, count: faqs.filter((f) => f.category === 'general').length },
        {
            ...
            name: 'Применение',
            icon: Stethoscope,
            count: faqs.filter((f) => f.category === 'usage').length,
        },
        {
            id: 'dosage',
            name: 'Дозировка',
            icon: AlertTriangle,
            count: faqs.filter((f) => f.category === 'dosage').length,
        },
    ...
    return (
        <div ref={ref} className="custom-overflow-y-hide space-y-12">
            {/* Introduction */}
            <motion.div
            ...
            >
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                    Наши ветеринарные эксперты собрали наиболее частые вопросы и подготовили подробные ответы для
                    обеспечения безопасного и эффективного применения препарата.
                </p>
            </motion.div>
            ...
            <motion.div
                ...
                className="custom-overflow-visible  max-w-4xl mx-auto space-y-4"
            >
            ...
            >
                <div className="hud-element p-8 rounded-lg max-w-2xl mx-auto">
                    ...
                    <p className="text-gray-300 mb-6">
                        Если вы не нашли ответа на свой вопрос, наши эксперты готовы предоставить персональную
                        консультацию по применению препарата ВЕЗОТИЛ.
                    </p>
