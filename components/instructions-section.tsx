  ...
  const steps = [
    {
      ...
      details: ['Добавить 5 мл стерильной воды', 'Аккуратно перемешать до полного растворения', 'Проверить прозрачность раствора']
    },
    {
      icon: Calculator,
    ...
    },
    {
      ...
      details: ['Следить за дыханием и пульсом', 'Контролировать температуру тела', 'Фиксировать время восстановления']
    }
  ];
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-slate-800 to-slate-900">
      <div className="container mx-auto px-4 lg:px-8 xl:px-12">
        ...
        >
          <h3 className="text-xl sm:text-2xl font-bold hud-text text-center mb-6 sm:mb-8">Временная шкала действия</h3>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="hud-element p-3 rounded-lg">
                        ...
                        <div className="text-white text-sm leading-tight break-words">{item?.event}</div>
                      </div>
                    </div>
                  </motion.div>
                ))}
