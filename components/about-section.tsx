      ...
      <div className="container mx-auto px-4 lg:px-8 xl:px-12">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Инновационный ветеринарный лиофилизат для приготовления раствора для инъекций. 
            Разработан ООО "ВЕТСТЕМ" для безопасной и эффективной анестезии животных.<br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                Тилетамин обеспечивает диссоциативную анестезию, блокируя NMDA-рецепторы. 
                Золазепам усиливает действие ГАМК, обеспечивая седативный эффект и мышечную релаксацию.
              </p>
              <p className="text-gray-300 leading-relaxed">
                Комбинация обеспечивает сбалансированную анестезию с минимальными побочными эффектами 
