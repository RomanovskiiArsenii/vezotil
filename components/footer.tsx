        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} ООО "ВЕТСТЕМ". Все права защищены.
            </div>
            <div className="flex flex-wrap items-center gap-4 text-gray-400 text-sm">
              <a href="/privacy" className="hover:text-cyan-300 transition-colors">Политика конфиденциальности</a>
              <span>•</span>
              <a href="/adverse-reactions" className="hover:text-cyan-300 transition-colors">Сообщить о побочном эффекте</a>
            </div>
            <div className="text-gray-400 text-sm text-center lg:text-right">
              Регистрационное удостоверение:<br />
              № 77-3-29.23-5075ПВР-3-29.23/03889 от 28.12.2023 г.
            </div>
          </div>
        </motion.div>
      </div>
