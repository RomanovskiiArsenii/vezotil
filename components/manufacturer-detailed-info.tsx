...
export default function ManufacturerDetailedInfo() {
    ...
    return (
        <div ref={ref} className="custom-overflow-y-hide space-y-20">
            {/* Company Overview */}
            <motion.div
            ...
            >
                <div className="space-y-6">
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed">
                        Компания «ВЕТСТЕМ» была основана в 2020 году с целью создания инновационных клеточных препаратов
                        для регенеративной терапии и передовых высококачественных ветеринарных препаратов для
                        российского и международного рынков. Мы специализируемся на разработке и производстве
                        инновационных лекарственных средств для животных.
                    </p>

                    <p className="text-gray-300 text-lg leading-relaxed">
                        Наша миссия — обеспечить ветеринарных врачей эффективными и безопасными препаратами, которые
                        помогают сохранить здоровье и улучшить качество жизни животных. Мы постоянно инвестируем в
                        исследования и разработки, следуя самым современным научным достижениям.
                    </p>
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div className="text-gray-300">
                                    Россия, 121205, г. Москва, территория Сколково инновационного центра, Большой
                                    бульвар, д. 42, стр. 1, пом. 209
                                </div>
                            </div>
                        </div>
                ...
                <div className="custom-alighn-self-end space-y-6">
                    {/* Stats */}
            ...
            >
                ...
                <div className="relative">
                    {/* Timeline line */}
                    <div className="custom-margin-left-7 custom-pc-hide absolute left-4 md:left-1/2 transform md:-translate-x-0.5 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-400 to-purple-400" />
                    ...
                    <div className="space-y-12">
                        {achievements.map((achievement, index) => (
                            ...
                            >
                                <div
                                    className={`flex-1 ${index % 2 === 0 ? 'md:pr-8 pl-12' : 'md:pl-8 pl-12'} md:pl-0`}
                                >
                                ...
                                {/* Timeline dot */}
                                <div className="custom-pc-hide absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-4 h-4 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full border-4 border-slate-900" />
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            >
                ...
                <div className="custom-overflow-visible grid grid-cols-1 md:grid-cols-3 gap-6">
