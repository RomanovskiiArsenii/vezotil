...
export default function AdvantagesSection() {
    ...
    return (
        <section
            id="advantages"
            className="pt-32 pb-20 bg-gradient-to-b from-slate-800 to-slate-900 relative overflow-hidden"
        >
                    ...
                    <div className="custom-height-100 custom-flex-column custom-justify-sb space-y-8">
                        ...
                        >
                            <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-slate-800">
                                ...
                                <div className="custom-margin-top-16 absolute top-4 left-4 hud-element p-3 rounded-lg floating">
