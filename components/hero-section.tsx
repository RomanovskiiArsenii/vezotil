...
export default function HeroSection() {
    ...
    return (
        <section id="hero" className="min-h-screen medical-bg relative overflow-hidden flex items-center pt-20">
            {/* Background video */}
            <div className="absolute inset-0 z-0 custom-overflow-y-hide">
                <video className="hero-video w-full h-full" autoPlay muted loop playsInline preload="auto">
            ...
            <div className="container mx-auto px-4 lg:px-8 xl:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-8">
                ...
                <motion.div
                    ...
                    className="space-y-8 custom-overflow-y-hide"
                >
                    <motion.h1
                    ...
                    >
                        ...
                        <span className="text-white text-3xl md:text-4xl block mt-1">Инновационная</span>
                        <span className="text-white text-3xl md:text-4xl block -mt-1">анестезия</span>
                    </motion.h1>
                    ...
                    >
                        Безопасный и эффективный ветеринарный препарат для анестезии с точной дозировкой. Тилетамин +
                        Золазепам для профессиональной ветеринарной практики.
                    </motion.p>
                    ...
                    >
                        <button
                            ...
                            style={{
                                ...
                                boxShadow:
                                    '0 4px 12px rgba(59, 130, 246, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -1px 0 rgba(59, 130, 246, 0.2)',
                            }}
                        >
                        ...
                        <button
                            ...
                            style={{
                                ...
                                boxShadow:
                                    '0 4px 12px rgba(16, 185, 129, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -1px 0 rgba(16, 185, 129, 0.2)',
                            }}
                        >
                            {/* Подсветка по периметру */}
                            ...
                            <div className="relative flex items-center justify-center z-10">Заказать препарат</div>
                        </button>
                    </motion.div>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative w-full max-w-sm">
                        ...
                        >
                            <div className="hud-element px-3 py-1.5 rounded-lg shadow-lg border border-cyan-400/30">
                                <div className="hud-text text-xs font-semibold whitespace-nowrap">
                                    DOSAGE: CALCULATED
                                </div>
                            </div>
                        </motion.div>
