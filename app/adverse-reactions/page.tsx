...
export const metadata: Metadata = {
  ...
  description: 'Форма для сообщения о нежелательных реакциях и побочных эффектах препарата ВЕЗОТИЛ. Система фармаконадзора.',
}
...
export default function AdverseReactionsPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Нежелательные реакции"
        subtitle="Система мониторинга безопасности препарата ВЕЗОТИЛ"
      />
            ...
            <div className="space-y-6">
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-3 text-gray-300">
                  ...
                  <p>
                    О любой нежелательной реакции, возникшей в процессе применения препарата, 
                    просим сообщить производителю ООО "ВЕТСТЕМ".
                  </p>
                  <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4">
                    <p className="text-yellow-300 font-semibold">Внимание!</p>
                    <p className="text-yellow-200 text-sm">
                      В случае серьезной нежелательной реакции немедленно обратитесь к ветеринарному врачу 
                      и сообщите о случившемся по телефону горячей линии: +7 (917) 525-77-70
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-300 text-sm">
                    Для сообщения о серьезных нежелательных реакциях, требующих немедленного внимания
                  </p>
                </div>
              </div>
