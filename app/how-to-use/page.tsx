...
export default function HowToUsePage() {
  ...
  return (
    <PageLayout>
      <PageHeader
        title="Как использовать ВЕЗОТИЛ"
        subtitle="Пошаговое руководство по применению препарата"
      />
      ...
      <ContentSection>
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Препарат предназначен только для применения ветеринарными врачами. 
                  Строго соблюдайте дозировку и противопоказания. 
                  При возникновении нежелательных реакций немедленно обратитесь к специалисту.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                    <div className="md:col-span-1">
                      <div className="flex items-center gap-4 mb-4">
                        <div className={`w-16 h-16 bg-gradient-to-r ${step.color} rounded-full flex items-center justify-center border`}>
                          <step.icon className="w-8 h-8 text-white" />
                        </div>
                        <div className="text-4xl font-bold text-cyan-400">{step.step}</div>
                      </div>
                ...
                <div className="overflow-hidden rounded-lg border border-cyan-500/30">
                  <table className="w-full">
                    <thead className="bg-cyan-500/20">
                      <tr>
                        <th className="px-4 py-3 text-left text-sm font-semibold text-cyan-300">Цель применения</th>
                        <th className="px-4 py-3 text-center text-sm font-semibold text-cyan-300">В/м</th>
                        <th className="px-4 py-3 text-center text-sm font-semibold text-cyan-300">В/в</th>
                      </tr>
                    </thead>
                    <tbody>
                      {dosageTable.dogs.map((row, idx) => (
                        <tr key={idx} className="border-t border-cyan-500/20">
                          ...
                          <td className="px-4 py-3 text-sm text-white text-center font-mono">{row.im}</td>
                          <td className="px-4 py-3 text-sm text-white text-center font-mono">{row.iv}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          <div className="glass-card p-8 bg-gradient-to-br from-red-900/20 to-orange-900/20 border-red-500/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-red-300 mb-4">Абсолютные противопоказания:</h3>
