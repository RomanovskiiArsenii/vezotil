...
const webinars = [
    {
        ...
        duration: '90 минут',
        description:
            'Уникальный взгляд на анестезию диких животных от ведущего специалиста России. Рассматриваются особенности применения ВЕЗОТИЛ у различных видов зоопарковых животных.',
        topics: [
        ...
        rutube_url:
            'https://rutube.ru/video/a782bc33fc81210af67ab54cceeb21b5/?utm_source=embed&utm_medium=referral&utm_campaign=main_logo&utm_content=a782bc33fc81210af67ab54cceeb21b5&utm_term=vezotil.ru&t=0',
    ...
    },
    {
        ...
        duration: '75 минут',
        description:
            'Фундаментальные основы действия диссоциативных анестетиков и бензодиазепинов. Детальный разбор механизмов действия ВЕЗОТИЛ.',
        topics: [
        ...
        rutube_url:
            'https://rutube.ru/video/12ba07cb7677ef00b1b922b6e540a342/?utm_source=embed&utm_medium=referral&utm_campaign=main_logo&utm_content=12ba07cb7677ef00b1b922b6e540a342&utm_term=vezotil.ru&t=0',
        rutube_embed: '12ba07cb7677ef00b1b922b6e540a342',
        preview_image:
            'https://i.ytimg.com/vi/NEtjFkQr4SY/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLB3f0jJxvbbZvusNhkbpKVuNvuM0A',
    ...
    },
    {
        ...
        duration: '60 минут',
        description:
            'Комплексный подход к предоперационной подготовке пациентов. Протоколы премедикации при использовании ВЕЗОТИЛ.',
        topics: [
        ...
        rutube_url:
            'https://rutube.ru/video/8e9ae854be804645dba6a0102e384c65/?utm_source=embed&utm_medium=referral&utm_campaign=main_logo&utm_content=8e9ae854be804645dba6a0102e384c65&utm_term=vezotil.ru&t=0',
    ...
    },
    {
        ...
        duration: '85 минут',
        description:
            'Особенности анестезиологического обеспечения экстренных пациентов. Быстрые протоколы с использованием ВЕЗОТИЛ.',
        topics: [
        ...
        rutube_url:
            'https://rutube.ru/video/af816a24e11f09618cd1ccb9e49d1c21/?utm_source=embed&utm_medium=referral&utm_campaign=main_logo&utm_content=af816a24e11f09618cd1ccb9e49d1c21&utm_term=vezotil.ru&t=0',
    ...
    },
    {
        ...
        duration: '70 минут',
        description:
            'Инновационные подходы к анестезии при операциях на желудочно-кишечном тракте без использования опиоидных анальгетиков.',
        topics: [
        ...
        rutube_url:
            'https://rutube.ru/video/3fcbd15c1000d8b674a296980dfb9327/?utm_source=embed&utm_medium=referral&utm_campaign=main_logo&utm_content=3fcbd15c1000d8b674a296980dfb9327&utm_term=vezotil.ru&t=0',
    ...
    },
    {
        ...
        duration: '95 минут',
        description:
            'Полный обзор диссоциативных анестетиков в ветеринарной практике. Место ВЕЗОТИЛ среди современных анестетиков.',
        topics: [
        ...
        rutube_url:
            'https://rutube.ru/video/7c4e36cdc09a4123b078eaf9f1cf3a19/?utm_source=embed&utm_medium=referral&utm_campaign=main_logo&utm_content=7c4e36cdc09a4123b078eaf9f1cf3a19&utm_term=vezotil.ru&t=0',
        rutube_embed: '7c4e36cdc09a4123b078eaf9f1cf3a19',
        preview_image:
            'https://i.ytimg.com/vi/piM6Qw_115w/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLBQiAxcRrFxuY6vofRqygyhXCs3Rg',
        category: 'Фармакология',
    },
    {
        id: 'vezotil-lecture',
        ...
        rutube_url:
            'https://rutube.ru/video/b703f190a6870226f3a3b5fcc044ad09/?utm_source=embed&utm_medium=referral&utm_campaign=main_logo&utm_content=b703f190a6870226f3a3b5fcc044ad09&utm_term=vezotil.ru&t=0',
        rutube_embed: 'b703f190a6870226f3a3b5fcc044ad09',
        preview_image:
            'https://lh4.googleusercontent.com/Dgih5atMTBqXM7zIFIYXN7Ga15ZDrcnUwsVJ8y-603HXmmTLHNrUReiyZD2yZo5CWzdsABx3qXpSl5GIvsLoq_xHcooPAqED597tgp9je96otq3hYpDimJxQuLf3BicKZj7QMvFc',
    ...
    },
    {
        ...
        rutube_url:
            'https://rutube.ru/video/11cc0fef210f3c0acf08535b37c37ccc/?utm_source=embed&utm_medium=referral&utm_campaign=main_logo&utm_content=11cc0fef210f3c0acf08535b37c37ccc&utm_term=vezotil.ru&t=0',
...
export default function WebinarsPage() {
    ...
    const categories = [
        { id: 'all', label: 'Все вебинары', count: webinars.length },
        {
            id: 'Фармакология',
            label: 'Фармакология',
            count: webinars.filter((w) => w.category === 'Фармакология').length,
        },
        {
            id: 'Экзотические животные',
            label: 'Экзотические животные',
            count: webinars.filter((w) => w.category === 'Экзотические животные').length,
        },
    ...
    return (
        <PageLayout>
            <PageHeader title="Вебинары" subtitle="Образовательные материалы для ветеринарных специалистов" />
                ...
                <div className="max-w-6xl mx-auto space-y-12">
                    ...
                    <div className="glass-card p-8 space-y-6">
                        ...
                        <p className="text-xl text-gray-300 leading-relaxed">
                            Коллекция образовательных вебинаров от ведущих специалистов в области ветеринарной
                            анестезиологии. Практические знания и научные основы применения препарата ВЕЗОТИЛ в
                                    ...
                                    <div className="hud-element p-8 rounded-xl scan-line hover:medical-glow transition-all duration-500 custom-after-before-no-poiner-events">
                                        <div className="grid lg:grid-cols-12 gap-8 items-start">
                                            ...
                                            <div className="lg:col-span-9 space-y-4">
                                                ...
                                                <p className="custom-max-width-550 text-gray-300 leading-relaxed">
                                                    {webinar.description}
                                                </p>
                                            ...
                                            <div className="lg:col-span-3 flex justify-center">
                                                ...
                                                >
                                                    <div className="flex items-center gap-2 text-red-100 group-hover/btn:text-white font-medium">
                                                        ...
                                                        <ExternalLink className="custom-flex-shrink-0w-4 h-4" />
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-2">
                            <div className="medical-card p-6 text-center space-y-4 group">
                                ...
                                <p className="text-gray-300 text-sm">
                                    Специализированные протоколы для зоопарковых и диких животных
                                </p>
                            </div>
                            ...
                            <div className="medical-card p-6 text-center space-y-4 group">
                                ...
                                <p className="text-gray-300 text-sm">
                                    Практические аспекты применения в повседневной работе
                                </p>
                            </div>
