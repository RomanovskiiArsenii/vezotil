...
const newsData: Record<string, any> = {
  ...
  'production-expansion-vezotil': {
    ...
    featuredImage: 'https://sika.scene7.com/is/image/sika/usa-pharamceutical-white-room-stock:16-9?wid=1920&hei=1080&fit=crop%2C1'
  },
  'vezotil-registration-approved': {
    ...
    content: `
      ...
      <p>Препарат ВЕЗОТИЛ отличается от аналогов высокой безопасностью применения и контролируемостью анестезии. Время наступления эффекта составляет всего 2-5 минут, что значительно сокращает время подготовки к хирургическим вмешательствам.</p>
