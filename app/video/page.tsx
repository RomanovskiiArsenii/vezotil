    ...
    const videos = [
        {
            ...
            description:
                'Лекция ветеринарного врача, анестезиолога-реаниматолога Вдовиной Дарьи Александровны о препарате "Везотил®"',
        ...
        },
        {
            ...
            description:
                'Мнение ведущих врачей-анестезиологов Атанасовой С, Оленчука С, Корнюшенкова Е об анестетике "Везотил"',
        ...
        },
        {
            ...
            description:
                'Отзыв Бабуновой Ольги Дмитриевны - ветеринарного анестезиолога-реаниматолога о препарате Везотил',
            ...
            <ContentSection>
                <div className="max-w-7xl mx-auto space-y-8" id="custom-rewiews-id">
                    ...
                    <div className="glass-card p-8 space-y-8">
                        <h2 className="text-2xl font-bold text-cyan-100 mb-6">Видео отзывы и лекции</h2>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-8">
                            {videos.map((video, index) => (
                                <div key={video.id} className="space-y-6 flex flex-col">
                                    ...
                                    <div className="custom-flex-column medical-card p-6 space-y-4 flex-1">
                                        <h3 className="custom-flex-grow-2 font-semibold text-cyan-100 text-base leading-relaxed">
                                            {video.title}
                                        </h3>
                    ...
                    <div className="glass-card p-8 space-y-6">
                        <h2 className="text-2xl font-bold text-cyan-100 mb-6">Руководители исследований</h2>
                    ...
                    <div className="glass-card p-8 space-y-6">
                        <h2 className="text-2xl font-bold text-cyan-100 mb-6">Клинический опыт применения</h2>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="medical-card p-6">
                                <h3 className="text-lg font-semibold text-cyan-100 mb-4">
                                    Статистика применения (по данным видео отзывов):
                                </h3>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="border border-cyan-500/30 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-400 text-xs">
                                            Специализация: Анестезиология и реаниматология
                                        </p>
                                    </div>
                                    <div className="border border-cyan-500/30 rounded-lg p-4">
