                ...
                <div className="max-w-6xl mx-auto space-y-12">
                    ...
                    <div className="glass-card p-8 space-y-8">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="custom-mobile-hide w-16 h-16 bg-purple-500/20 rounded-xl border border-purple-400/30 flex items-center justify-center">
                                <Building className="w-8 h-8 text-purple-400" />
                            </div>
                            <div>
                                <h2 className="text-2xl font-bold text-cyan-100">Ветеринарная клиника «Пантера»</h2>
                        ...
                        <div className="space-y-8">
                            <div className="medical-card p-6 space-y-4">
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    Основной целью исследования в клинике «Пантера» была оценка переносимости препарата
                                    ВЕЗОТИЛ у животных различных возрастных групп, включая молодых, взрослых и пожилых
                                    пациентов.
                                </p>
                            </div>
                        ...
                        <div className="space-y-6">
                            <div className="medical-card p-6 space-y-4">
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    во время анестезии. Все животные демонстрировали стабильные показатели
                                    сердечно-сосудистой и дыхательной систем на протяжении всего периода анестезии.
                                </p>
                            ...
                            <div className="bg-gradient-to-r from-green-900/20 to-cyan-900/20 border border-green-400/30 rounded-lg p-6">
                                ...
                                <p className="text-green-100 text-sm leading-relaxed">
                                    ...
                                    возрастных групп. Минимальный период восстановления и стабильные витальные
                                    показатели подтверждают возможность безопасного применения препарата в клинической
                                    практике.
                                </p>
                            </div>
                        </div>
