                ...
                <div className="max-w-6xl mx-auto space-y-12">
                    ...
                    <div className="glass-card p-8 space-y-8">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="custom-mobile-hide w-16 h-16 bg-yellow-500/20 rounded-xl border border-yellow-400/30 flex items-center justify-center">
                                <Hospital className="w-8 h-8 text-yellow-400" />
                            </div>
                            <div>
                                <h2 className="text-2xl font-bold text-cyan-100">Сеть ветеринарных клиник «Бэст»</h2>
                                    ...
                                    <div className="space-y-3 text-gray-300">
                                        <div>
                                            <p className="font-medium text-cyan-200">
                                                Коллектив ветеринарных врачей сети Бэст
                                            </p>
                                            <p className="text-sm text-gray-400">
                                                Специалисты анестезиологии и хирургии
                                            </p>
                                        </div>
                                        <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="medical-card p-6 space-y-4">
                                <h3 className="text-lg font-semibold text-cyan-100">
                                    Особенности сетевого исследования
                                </h3>
                                <ul className="space-y-2 text-gray-300">
                            ...
                            <div className="medical-card p-6 space-y-4">
                                ...
                                <div className="space-y-4 text-gray-300">
                                    <p className="leading-relaxed">
                                        ...
                                        Особенно важна была продемонстрированная воспроизводимость результатов в
                                        различных филиалах сети при соблюдении единых протоколов.
                                    </p>
                                    <p className="leading-relaxed">
                                        Исследование подтвердило возможность успешного внедрения препарата в крупных
                                        ветеринарных сетях с сохранением высоких стандартов качества и безопасности
                                        анестезии.
                                    </p>
                                    <div className="bg-gradient-to-r from-yellow-900/20 to-orange-900/20 border border-yellow-400/30 rounded-lg p-4">
                                        <p className="text-yellow-200 font-medium">
                                            ...
                                            ветеринарных клиниках как надежный препарат с высокой воспроизводимостью
                                            результатов.
                                        </p>
                                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    специализирующихся на оказании полного спектра ветеринарных услуг. Все клиники сети
                                    работают по единым стандартам качества и безопасности.
                                </p>
