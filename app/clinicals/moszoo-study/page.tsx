        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="glass-card p-8 space-y-8">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-green-600/20 rounded-xl border border-green-400/30 flex items-center justify-center">
              ...
              <div className="space-y-6">
                <div className="medical-card p-6 space-y-4">
                  ...
                  <div className="space-y-3 text-gray-300">
                    <div>
                      <p className="font-medium text-cyan-200">Ветеринарная служба Московского зоопарка</p>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-8">
              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Отличная эффективность у разнообразных видов животных</h3>
                <p className="text-gray-300 leading-relaxed">
                  Исследование показало превосходную эффективность препарата ВЕЗОТИЛ у широкого спектра 
                  зоопарковых и экзотических животных. Препарат продемонстрировал стабильное действие 
                  независимо от биологических особенностей различных видов.
                </p>
              </div>
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-4 text-gray-300">
                  <p className="leading-relaxed">
                    Препарат ВЕЗОТИЛ показал выдающиеся результаты в применении у зоопарковых и экзотических 
                    животных. Особенно важна была продемонстрированная безопасность при работе с редкими 
                    и находящимися под угрозой исчезновения видами.
                  </p>
                  <p className="leading-relaxed">
                    Исследование подтвердило возможность безопасного использования препарата в условиях 
                    зоопарка при соблюдении видоспецифичных протоколов дозирования и мониторинга.
                  </p>
                  <div className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 border border-green-400/30 rounded-lg p-4">
                    <p className="text-green-200 font-medium">
                      🌟 Рекомендация: ВЕЗОТИЛ рекомендован для использования в зоологических парках 
                      как безопасный препарат для анестезии экзотических и диких животных.
                    </p>
                  </div>
          ...
          <div className="glass-card p-8 space-y-6">
            <h2 className="text-2xl font-bold text-cyan-100 mb-6">Особенности работы с зоопарковыми животными</h2>
