                ...
                <div className="max-w-6xl mx-auto space-y-12">
                    ...
                    <div className="glass-card p-8 space-y-8">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-cyan-100">Ветеринарная клиника «Четыре лапы»</h2>
                        ...
                        <div className="space-y-8">
                            <div className="medical-card p-6 space-y-4">
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    Клиника «Четыре лапы» провела детальную оценку анестезиологического качества
                                    препарата ВЕЗОТИЛ на 42 животных различных пород и возрастов. Исследование показало
                                    отличные результаты по всем ключевым параметрам анестезии.
                                </p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-gray-300 text-sm">
                                            Пациенты восстанавливались значительно быстрее, что позволяло сократить
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-gray-300 text-sm">
                                            Участник профессиональных ассоциаций
                                        </span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <Award className="w-5 h-5 text-yellow-400" />
