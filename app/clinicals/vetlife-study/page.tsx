        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="glass-card p-8 space-y-8">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-green-500/20 rounded-xl border border-green-400/30 flex items-center justify-center">
              ...
              <div className="space-y-6">
                <div className="medical-card p-6 space-y-4">
                  ...
                  <div className="space-y-3 text-gray-300">
                    <div>
                      <p className="font-medium text-cyan-200">Специалисты по анестезиологии ВетЛайф</p>
                      <p className="text-sm text-gray-400">Команда профессиональных анестезиологов</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Ответственный за проведение исследования</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-8">
              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Высокая эффективность при различных хирургических вмешательствах</h3>
                <p className="text-gray-300 leading-relaxed">
                  Исследование продемонстрировало высокую эффективность препарата ВЕЗОТИЛ при всех типах 
                  хирургических вмешательств. Препарат показал стабильные результаты независимо от 
                  сложности и продолжительности операций.
                </p>
              </div>
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-4 text-gray-300">
                  <p className="leading-relaxed">
                    Препарат ВЕЗОТИЛ показал превосходные результаты во всех аспектах многопрофильной 
                    ветеринарной практики. Особенно отмечается стабильность гемодинамических показателей 
                    и удобство применения для медицинского персонала.
                  </p>
                  <p className="leading-relaxed">
                    Исследование подтвердило универсальность препарата для использования при различных 
                    типах хирургических вмешательств с высокой степенью безопасности и эффективности.
                  </p>
                  <div className="bg-gradient-to-r from-green-900/20 to-blue-900/20 border border-green-400/30 rounded-lg p-4">
                    <p className="text-green-200 font-medium">
                      🏆 Рекомендация: ВЕЗОТИЛ рекомендуется как препарат первого выбора для анестезии 
                      в условиях многопрофильной ветеринарной практики.
                    </p>
                  </div>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <p className="text-gray-300 leading-relaxed">
                  Ветеринарная клиника «ВетЛайф» — современное медицинское учреждение, специализирующееся 
                  на оказании полного спектра ветеринарных услуг. Клиника оснащена передовым 
