            ...
            <div className="space-y-8">
              <div className="medical-card p-6 space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Исследование продемонстрировало терапевтическую эквивалентность препаратов Везотил® и Золетил® 100. 
                  Оба препарата показали сопоставимую эффективность в обеспечении анестезии у кошек и собак 
                  при проведении плановых хирургических вмешательств.
                </p>
              </div>
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-4 text-gray-300">
                  <p className="leading-relaxed">
                    Препарат Везотил® продемонстрировал терапевтическую эквивалентность препарату Золетил® 100 
                    по основным показателям анестезиологической активности. При этом отмечены некоторые 
                    преимущества Везотила в части седативного эффекта и комфорта для животных.
                  </p>
                  <p className="leading-relaxed">
                    Исследование подтвердило безопасность применения препарата Везотил® у кошек и собак 
                    различных пород и возрастов при соблюдении рекомендованных дозировок и протоколов применения.
                  </p>
            ...
            <div className="space-y-6">
              <div className="medical-card p-6 space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  Животные были случайным образом распределены в две группы: группа Везотил® (n=14) 
                  и группа Золетил® 100 (n=14).
                </p>
              </div>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <p className="text-gray-300 leading-relaxed">
                  Ветеринарный онкологический научный центр «Биоконтроль» — ведущее учреждение 
                  в области ветеринарной онкологии и анестезиологии в России. Центр специализируется 
                  на лечении онкологических заболеваний у животных и проведении научных исследований.
                </p>
