...
const clinicalStudies = [
    {
        ...
        summary:
            'Пилотное сравнительное клиническое исследование анестезиологической активности препаратов Везотил® и Золетил® 100',
        keyFindings: [
                ...
                <div className="max-w-6xl mx-auto space-y-12">
                    ...
                    <div className="glass-card p-8 space-y-6">
                        ...
                        <p className="text-xl text-gray-300 leading-relaxed">
                            Препарат ВЕЗОТИЛ прошел обширные клинические исследования в ведущих ветеринарных клиниках
                            России, которые подтвердили высокую эффективность и безопасность препарата для анестезии
                            кошек и собак различных пород и возрастов.
                        </p>
                        ...
                        <div className="custom-overflow-y-hide grid gap-8">
                            {clinicalStudies.map((study, index) => (
                                <motion.div
                                    ...
                                    className="group"
                                >
                                    <div className="hud-element p-8 rounded-xl scan-line hover:medical-glow transition-all duration-500 m-2 custom-after-before-no-poiner-events">
                                        <div className="grid lg:grid-cols-12 gap-8">
                                            {/* Clinic Logo */}
                                            <div className="custom-overflow-visible lg:col-span-2">
                                                <div
                                                    className={`relative w-32 h-32 mx-auto rounded-xl border overflow-hidden transition-colors ${
                                                ...
                                                >
                                                    <div
                                                        className={`custom-logo-bg absolute inset-0 ${
                                                            study.id === 'best-clinical-study'
                                                    ...
                                                    <div className="space-y-2">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-gray-300">
                                                                Авторы: {study.authors}
                                                            </span>
                                                        </div>
                                                        <div className="flex items-center gap-2">
                                                            <Calendar className="w-4 h-4 text-gray-400" />
                                                            <span className="text-gray-300">
                                                                Период: {study.duration}
                                                            </span>
                                                        </div>
                                                    </div>
                                                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="medical-card p-6 space-y-4">
                                ...
                                <div className="space-y-2 text-gray-200">
                                    <p>• Быстрое наступление анестезии (3-5 минут)</p>
