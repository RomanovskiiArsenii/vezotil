        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="glass-card p-8 space-y-8">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-blue-500/20 rounded-xl border border-blue-400/30 flex items-center justify-center">
          ...
          <div className="glass-card p-8 space-y-6">
            <h2 className="text-2xl font-bold text-cyan-100 mb-6">Результаты двухцентрового исследования</h2>
            ...
            <div className="space-y-8">
              <div className="medical-card p-6 space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Одним из ключевых достижений исследования стала демонстрация воспроизводимости результатов 
                  применения препарата ВЕЗОТИЛ в различных локациях. Оба филиала клиники ВетПрофАльянс 
                  показали идентичные результаты по основным параметрам эффективности и безопасности.
                </p>
              </div>
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Исследование также включало анализ экономической эффективности применения препарата ВЕЗОТИЛ. 
                  Результаты показали положительное соотношение затрат и клинических результатов, 
                  что делает препарат привлекательным для широкого клинического применения.
                </p>
                ...
                <div className="bg-gradient-to-r from-green-900/20 to-cyan-900/20 border border-green-400/30 rounded-lg p-4">
                  <p className="text-green-200 font-medium text-sm">
                    💰 Экономический эффект: Снижение общих затрат на анестезию на 15-20% 
                    при сохранении высокого качества процедур.
                  </p>
                </div>
              </div>
            </div>
