...
export const metadata: Metadata = {
  ...
  description: 'Сертификаты качества препарата ВЕЗОТИЛ. GMP, ISO 9001, государственная регистрация Росздравнадзор.',
}
            ...
            <div className="text-center mb-8">
              ...
              <div className="bg-slate-800/50 border border-cyan-500/30 rounded-lg p-6 max-w-2xl mx-auto">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white">Регистрационное удостоверение</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-white">28.12.2023 г.</p>
                  </div>
                  <div>
