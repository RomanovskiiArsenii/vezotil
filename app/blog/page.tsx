...
export const metadata: Metadata = {
  ...
  description: 'Научные публикации, клинические исследования и вебинары о ветеринарной анестезии. Профессиональные материалы для специалистов.',
  keywords: 'ветеринарная анестезия, научные публикации, клинические исследования, вебинары, ВЕЗОТИЛ, ветеринарное образование',
  openGraph: {
...
const educationSections = [
  ...
  },
  {
    id: 'webinars',
    title: 'Вебинары',
    description: 'Образовательные вебинары и видеоматериалы для ветеринарных специалистов по применению препарата ВЕЗОТИЛ',
    icon: Video,
    href: '/webinars',
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Доступ к научным публикациям, клиническим исследованиям и образовательным вебинарам 
              о применении препарата ВЕЗОТИЛ в ветеринарной практике
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 px-4">
            {educationSections.map((section, index) => (
              <div key={section.id} className="group mobile-card p-6">
                <Link href={section.href}>
                  <div className={`
                    relative backdrop-blur-lg border rounded-xl cursor-pointer
                  ...
                  `}>
                    ...
                    <div className="relative flex-1 p-8 text-center space-y-6 flex flex-col justify-between">
                      {/* Icon */}
          ...
          <div className="relative backdrop-blur-lg bg-slate-900/20 border border-cyan-500/30 rounded-xl p-8 hover:border-cyan-400/50 transition-all duration-300">
            ...
            <div className="relative text-center space-y-8">
              <h3 className="text-2xl font-bold text-cyan-100">
                О наших образовательных материалах
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-300 p-4">
                <div className="space-y-4 group p-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">Все материалы основаны на клинических исследованиях и научных данных</p>
                </div>
                ...
                <div className="space-y-4 group p-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">Готовые протоколы и рекомендации для повседневной практики</p>
                </div>
                ...
                <div className="space-y-4 group p-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">Видеоматериалы и вебинары от ведущих специалистов</p>
                </div>
              </div>
            </div>
          </div>
