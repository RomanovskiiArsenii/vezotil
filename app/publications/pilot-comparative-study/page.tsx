        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-6">
              <p className="text-gray-300 leading-relaxed text-lg">
                Данное пилотное исследование представляет собой первое комплексное сравнение анестезиологической 
                активности нового отечественного препарата Везотил® с его оригинальным аналогом Золетил® 100. 
                Исследование проводилось с целью оценки терапевтической эквивалентности препаратов и выявления 
                потенциальных преимуществ российского аналога.
              </p>

              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Цель исследования</h3>
                <p className="text-gray-300 leading-relaxed">
                  Провести сравнительную оценку анестезиологической активности препаратов Везотил® и Золетил® 100 
                  у кошек и собак, определить терапевтическую эквивалентность и выявить клинически значимые 
                  различия в действии препаратов.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="bg-gradient-to-r from-green-900/20 to-cyan-900/20 border border-green-400/30 rounded-lg p-6 space-y-4">
                  ...
                  <ul className="space-y-2 text-green-100 text-sm">
                    <li>• Препарат Везотил® продемонстрировал полную терапевтическую эквивалентность Золетил® 100</li>
                    <li>• Статистически значимых различий в основных показателях анестезии не выявлено</li>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Основные статистические результаты</h3>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-gradient-to-r from-cyan-900/20 to-blue-900/20 border border-cyan-400/30 rounded-lg p-4">
                    <p className="text-cyan-200 font-medium text-sm">
                      📊 Статистический вывод: Отсутствие статистически значимых различий (p {">"}0.05) 
                      подтверждает терапевтическую эквивалентность препаратов.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-4 text-gray-300">
                  <p className="leading-relaxed">
                    ...
                    оригинальному препарату Золетил® 100 по всем основным показателям анестезиологической активности.
                  </p>
                  <p className="leading-relaxed">
                    2. Выявлены некоторые клинические преимущества Везотила: более выраженная седация 
                    в период индукции и значительно меньшая саливация.
                  </p>
                  <p className="leading-relaxed">
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  препарата Везотил® в качестве альтернативы Золетил® 100 в ветеринарной анестезиологической практике. 
                  Это особенно важно в контексте импортозамещения и обеспечения доступности качественных 
                  анестетиков для российских ветеринарных клиник.
                </p>
              </div>

              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Перспективы дальнейших исследований</h3>
                <ul className="space-y-2 text-gray-300 text-sm">
