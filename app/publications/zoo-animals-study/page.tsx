              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-3 text-gray-300">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Главный ветеринарный врач Московского зоопарка</p>
                  </div>
                  <div>
            ...
            <div className="space-y-6">
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Исследование показало, что препарат Везотил® эффективен у всех исследованных видов животных, 
                  однако требует корректировки дозировок в зависимости от вида, размера и физиологических 
                  особенностей. Особенно выраженный эффект наблюдался у хищных млекопитающих.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-6">
              <div className="grid gap-6">
                <div className="medical-card p-6 space-y-4">
                  <h3 className="text-lg font-semibold text-cyan-100">Крупные хищники (тигры, леопарды)</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-r from-green-900/20 to-cyan-900/20 border border-green-400/30 rounded-lg p-6">
                ...
                <p className="text-green-100 text-sm leading-relaxed">
                  Препарат Везотил® показал высокую эффективность и безопасность при использовании 
                  у различных видов зоопарковых животных, что открывает новые возможности 
                  для ветеринарной помощи в зоопарках и заповедниках.
                </p>
              </div>
            </div>
          </div>
