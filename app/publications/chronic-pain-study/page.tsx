      ...
      <ContentSection>
        <div className="max-w-6xl mx-auto space-y-12">
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-4">
                  <p className="text-gray-300 leading-relaxed text-sm">
                    Данное исследование открывает новые перспективы использования препарата Везотил® 
                    не только для анестезии, но и для долгосрочного управления хронической болью 
                    у животных с ортопедическими заболеваниями.
                  </p>
            ...
            <div className="space-y-6">
              <div className="medical-card p-6 space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Хроническая ортопедическая боль является серьезной проблемой в ветеринарной медицине, 
                  существенно снижающей качество жизни животных. Традиционные подходы к обезболиванию 
                  не всегда обеспечивают адекватный контроль боли при длительном применении.
                </p>
              </div>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-6">
              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Направления дальнейших исследований</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
              ...
              <div className="bg-gradient-to-r from-orange-900/20 to-red-900/20 border border-orange-400/30 rounded-lg p-6">
                ...
                <p className="text-orange-100 text-sm leading-relaxed">
                  ...
                  в ветеринарной медицине и может стать альтернативой традиционным анальгетикам 
