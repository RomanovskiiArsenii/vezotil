...
const scientificPublications = [
  {
    ...
    summary: 'Комплексное сравнительное исследование эффективности и безопасности препарата Везотил® в сравнении с оригинальным Золетил® 100',
  ...
  },
  {
    ...
    summary: 'Детальный анализ клинической эффективности препарата Везотил® в условиях реальной ветеринарной практики',
  ...
  },
  {
    ...
    summary: 'Инновационный подход к использованию Везотил® в лечении хронических болевых синдромов у мелких домашних животных',
  ...
  return (
    <PageLayout>
      <PageHeader
        ...
        subtitle="Исследования и публикации по препарату ВЕЗОТИЛ"
      />
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Препарат ВЕЗОТИЛ является предметом активных научных исследований в ведущих 
              ветеринарных центрах России. Представленные публикации демонстрируют научную 
              обоснованность применения препарата в различных областях ветеринарной медицины.
            </p>
                    ...
                    <div className="grid lg:grid-cols-12 gap-8 items-start">
                      ...
                      <div className="lg:col-span-7 space-y-4">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="text-gray-300">Дата публикации: {new Date(publication.date).toLocaleDateString('ru-RU')}</span>
                        </div>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="medical-card p-6 text-center space-y-4">
                <div className="w-16 h-16 bg-cyan-500/20 rounded-full flex items-center justify-center mx-auto">
                  <FlaskConical className="w-8 h-8 text-cyan-400" />
                </div>
                <h3 className="text-lg font-semibold text-cyan-100">Эффективность</h3>
                <p className="text-gray-300 text-sm">Исследования клинической эффективности препарата</p>
              ...
              <div className="medical-card p-6 text-center space-y-4">
                ...
                <h3 className="text-lg font-semibold text-cyan-100">Безопасность</h3>
              ...
              <div className="medical-card p-6 text-center space-y-4">
                ...
                <h3 className="text-lg font-semibold text-cyan-100">Специальные популяции</h3>
              ...
              <div className="medical-card p-6 text-center space-y-4">
                ...
                <h3 className="text-lg font-semibold text-cyan-100">Управление болью</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="medical-card p-6 space-y-4">
                ...
                <div className="space-y-3 text-gray-300">
                  <p>
                    ООО "ВЕТСТЕМ" активно поддерживает научные исследования препарата ВЕЗОТИЛ 
                    и предоставляет возможности для сотрудничества с исследовательскими центрами.
                  </p>
