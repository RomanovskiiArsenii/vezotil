        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="glass-card p-8 space-y-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-cyan-100">
                  Сравнительная клиническая оценка
                </h2>
                <p className="text-blue-300">Комплексное сравнение эффективности и безопасности • 2024</p>
              </div>
            </div>
            ...
            <div className="medical-card p-6 space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                Проведение комплексной сравнительной оценки клинической эффективности, безопасности 
                и переносимости нового российского препарата Везотил® в сравнении с референтным 
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-6">
              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Статистически значимые результаты</h3>
              ...
              <div className="medical-card p-6 space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  эффективность, но и превосходство по ряду важных клинических параметров. 
                  Особенно отмечены улучшения в качестве индукции и пробуждения, а также 
                  значительное снижение нежелательных побочных эффектов.
                </p>
