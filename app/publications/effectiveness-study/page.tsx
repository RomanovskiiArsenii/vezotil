        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-8">
              ...
              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Преимущества в клинической практике</h3>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="space-y-6">
              <div className="medical-card p-6 space-y-4">
                <h3 className="text-xl font-semibold text-cyan-100">Сравнительная таблица эффективности</h3>
