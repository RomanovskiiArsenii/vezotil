...
export const metadata: Metadata = {
    ...
    description:
        'Информация о компании ООО ВЕТСТЕМ - ведущем российском производителе ветеринарных препаратов. История, достижения, сертификаты качества.',
...
export default function AboutPage() {
    const breadcrumbs = [
        { label: 'Главная', href: '/' },
        { label: 'Производитель', href: '/about' },
    ];
